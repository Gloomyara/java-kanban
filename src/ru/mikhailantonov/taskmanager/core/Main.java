...
public class Main {
    ...
    //К getHistory save изначально прикрутил, т.к. если закоментить мейн
    //с 31 строки до конца кода история в файл не записывалась,
    //не догадался сразу засунуть в получение по ид.
    //Через lineSeparator не хотел запись делать т.к. после 2й финалки осадок от него остался...
    //StringJoiner, действительно, очень удобный!
    //Не понял нужно ли ловить в мэйне наше исключение или нет, но на всякий напишу try catch.
    //Спасибо за комментарии. С Новым Годом! И счастливого Рождества!
